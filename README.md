...
![Full Dashboard View](screenshots/dashboard_full_view.png)

### KPI Cards Overview

![KPI Cards Overview](screenshots/kpi_cards_overview.png)

### Average Loan Amount by Status

![Average Loan Amount by Status](screenshots/avg_loan_amount_by_status.png)

### Average Monthly Installment by Status

![Average Monthly Installment by Status](screenshots/avg_monthly_installment_by_status.png)

### Credit Status vs Loan Status

![Credit Status vs Loan Status](screenshots/credit_status_vs_loan_status.png)

### Guarantee Type vs Loan Status

![Guarantee Type vs Loan Status](screenshots/guarantee_vs_loan_status.png)

### Loan Type vs Loan Status

![Loan Type vs Loan Status](screenshots/loan_type_vs_loan_status.png)
...
├── dashboard/
│   └── Loan_Portfolio_Dashboard.xlsx
├── screenshots/
│   ├── dashboard_full_view.png
│   ├── kpi_cards_overview.png
│   ├── avg_loan_amount_by_status.png
│   ├── avg_monthly_installment_by_status.png
│   ├── credit_status_vs_loan_status.png
│   ├── guarantee_vs_loan_status.png
│   └── loan_type_vs_loan_status.png
├── scripts/
│   └── credit_classification.py
├── .gitignore
└── README.md
```
